...
if st.session_state.revisar_ruta and st.button("💾 Guardar Ruta"):
    ...
    costo_total = (
        costo_diesel_camion + costo_diesel_termo + sueldo + bono +
        d["casetas"] + extras + costo_cruce_convertido
    )
    ...
    nueva_ruta = {
        ...
        "Moneda_Costo_Cruce": d["moneda_costo_cruce"], "Costo_Cruce": d["costo_cruce"], "Costo Cruce Convertido": costo_cruce_convertido,
